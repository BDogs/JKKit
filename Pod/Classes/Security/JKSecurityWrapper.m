...
@implementation JKSecurityWrapper
...
{
    JKSecurityWrapperResult * sha = [self sha384:key];
...
+ (JKSecurityWrapperResult *)sha1WithData:(NSData *)hashData
{
    ...
    JKSecurityWrapperResult *result = [[JKSecurityWrapperResult alloc] initWithBytes:digest length:CC_SHA1_DIGEST_LENGTH];
    free(digest);
...
+ (JKSecurityWrapperResult *)sha224WithData:(NSData *)hashData
{
    ...
    JKSecurityWrapperResult *result = [[JKSecurityWrapperResult alloc] initWithBytes:digest length:CC_SHA224_DIGEST_LENGTH];
    free(digest);
...
+ (JKSecurityWrapperResult *)sha256WithData:(NSData *)hashData
{
    ...
    JKSecurityWrapperResult *result = [[JKSecurityWrapperResult alloc] initWithBytes:digest length:CC_SHA256_DIGEST_LENGTH];
    free(digest);
...
+ (JKSecurityWrapperResult *)sha384WithData:(NSData *)hashData
{
    ...
    JKSecurityWrapperResult *result = [[JKSecurityWrapperResult alloc] initWithBytes:digest length:CC_SHA384_DIGEST_LENGTH];
    free(digest);
...
+ (JKSecurityWrapperResult *)sha512WithData:(NSData *)hashData
{
    ...
    JKSecurityWrapperResult *result = [[JKSecurityWrapperResult alloc] initWithBytes:digest length:CC_SHA512_DIGEST_LENGTH];
    free(digest);
