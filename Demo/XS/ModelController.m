...
/*
 ...
 It also implements a custom method, viewControllerAtIndex: which is useful in
 the implementation of the data source methods, and in the initial configuration
 of the application.
...
- (NSUInteger)indexOfViewController:(DataViewController *)viewController {
  ...
  // For simplicity, this implementation uses a static array of model objects
  // and the view controller stores the model object; you can therefore use the
  // model object to identify the index.
...
- (UIViewController *)pageViewController:
  ...
  index--;
  return
      [self viewControllerAtIndex:index storyboard:viewController.storyboard];
}
